describe('note list model',function() {
  it('each note is created with a id', function(){
    var notelisty = new noteList ()
    notelisty.createNote("hello my name is jamie")
    notelisty.createNote("hello my name is alex")
    console.log(notelisty.list[0].id)
    instanceChecker.isTrue(notelisty.list[0].id === 0)
    instanceChecker.isTrue(notelisty.list[1].id === 1)
  })
})
